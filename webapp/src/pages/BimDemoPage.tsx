		...
		fields: [
			{
				...
				options: ["rectangular", "circular", "h_section"],
			},
		...
		fields: [
			{
				...
				type: "select",
				defaultValue: "fixed",
				options: ["fixed", "casement", "sliding", "awning"],
			},
		...
		fields: [
			{
				...
				type: "select",
				defaultValue: "simple",
				options: ["simple", "glass", "sliding_glass"],
			},
		...
		fields: [
			{
				...
				label: "Source .fcstd",
				type: "text",
				defaultValue: "wall.fcstd",
				hint: "Must exist in uploads or outputs",
			},
		...
		fields: [
			{
				...
				label: "Source .ifc",
				type: "text",
				defaultValue: "building.ifc",
				hint: "Must exist in uploads",
			},
										...
										.map(([k, v]) => (
											<div key={k} className="bg-white/5 rounded-lg p-2">
												...
												<span className="text-slate-200 ml-2 font-mono">
													{typeof v === "number" ? v.toLocaleString() : typeof v === "string" ? v : JSON.stringify(v)}
												</span>
											</div>
										))
								: null}
