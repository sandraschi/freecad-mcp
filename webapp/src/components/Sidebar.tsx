...
import { Box, Boxes, Bot, Cpu, FileText, Gauge, HelpCircle, Home, LayoutDashboard, Logs, Settings, ShoppingBag, Waves, Wrench } from "lucide-react";
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${
                isActive ? "bg-indigo-600 text-white shadow-lg shadow-indigo-600/20" : "text-slate-400 hover:text-slate-200 hover:bg-white/5"
              }`
            }
          >
