...
def register_fluidx3d_tools(
    ...
    async def cfd_fluidx3d_setup(
        ...
        of_case_name: Annotated[str, Field(description="OpenFOAM case name for auto-discovering STL from cfd_cases/<name>/geometry.stl. Overrides case_name for discovery.")] = "",
    ) -> dict:
        ...
        await cfd_fluidx3d_setup(case_name="pipe_from_of", domain_type="pipe", of_case_name="pipe_study", resolution_x=512)
        """
        ...
        if stl_src:
            ...
            stl_files = [dst]
        elif domain_type == "stl" and stl_file:
...
"""
        if stl_files:
            defines_content += "#define MOVING_BOUNDARIES\n"
